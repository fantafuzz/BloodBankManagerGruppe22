Public Class egenSkjemaBolk1
    Dim spm1 As New Sporsmaal("Har du fått informasjon om blodgivning?", "1_1", 1, New Point(51, 22))
    Dim spm2 As New Sporsmaal("Føler du deg frisk nå?", "1_2", 2, New Point(51, 22))
    Dim spm3 As New Sporsmaal("Hvis du har gitt blod tidligere, har du vært frisk i perioden fra forrige blodgivning og til nå?", "1_3", 3, New Point(51, 22))
    Dim spm4 As New Sporsmaal("Veier du 50kg eller mer?", "1_4", 4, New Point(51, 22))
    Dim spm5 As New Sporsmaal("Har du åpne sår, eksem eller hudsykdom?", "1_5", 5, New Point(51, 22))
    Dim spm6 As New Sporsmaal("Har du piercing i slimhinne?", "1_6", 6, New Point(51, 22))
    Dim svar As New ArrayList
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim feil As Boolean = valider(6)
        If feil Then
            Exit Sub
    ...
    Private Sub saveInfo()
        ...
        Next
    End Sub
    Private Function valider(ByVal antallSpm As Integer) As Boolean
