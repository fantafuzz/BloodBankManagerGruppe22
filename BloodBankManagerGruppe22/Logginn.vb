...
Telefon  72 57 31 00 eller 72 57 31 05")
    ...
    Private Sub ButtonRegistrer_Click_2(sender As Object, e As EventArgs) Handles ButtonRegistrer.Click
        Registrering.Show()
        Me.Hide()
    End Sub

    Private Sub ButtonLogInn_Click_1(sender As Object, e As EventArgs) Handles ButtonLogInn.Click
    ...
    Private Sub ButtonLogInnAnsatt_Click_1(sender As Object, e As EventArgs) Handles ButtonLogInnAnsatt.Click
